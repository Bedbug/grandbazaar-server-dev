define({ "api": [
  {
    ...
    "name": "GetTicket",
    "group": "Client",
    "description": "<p>This endpoint is called when the user requests to play a new game. Initial check have happened in the client about cost deductions. But this process is responsible to actual make them happen after all other processes have concluded.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
