...
router.post('/game_type',api.addgame_type);

router.route('/game_type/:id')
.get(api.game_type)
.put(api.editGame_type)
.delete(api.deleteGame_type);


router.route('/game_types')
.get(api.game_types)
 ...
 */
router.get('/game_types/search',api.searchGame_types);

//New quick Response Handling
router.get('/game_types/test', (req,res)=>
